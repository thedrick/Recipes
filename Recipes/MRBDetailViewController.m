...
@interface MRBDetailViewController ()
@property (strong, nonatomic) UIPopoverController *masterPopoverController;
- (void)configureView;
@end

@implementation MRBDetailViewController
...
- (void)configureView
{
  ...
  if (self.detailItem) {
    ...
    NSLog(@"Current selected recipe: %@", self.detailItem);
...
{
    barButtonItem.title = NSLocalizedString(@"Recipes", @"Recipes");
